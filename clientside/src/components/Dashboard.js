...
const Dashboard = () => {
  ...
  return (
    <div className="card" style={{marginTop: '15em'}}>
      <div className="card-body">
        ...
        {!loggedInUser.user.secret ? (
          <div
            ...
            role="alert"
            style={{width: '50%', textAlign: 'center', position: 'relative', left: '25%'}}
          >
            <strong style={{fontSize: '25px'}}>
              You have not activated 2 Factor authentification yet!{" "}
              <Link to="/dashboard/2fa"><br />
